...
export type GetDockerActiveContainerQueryVariables = Exact<{
  id: Scalars['PrefixedID']['input'];
}>;
...
export type GetDockerContainersQuery = { __typename?: 'Query', docker: { __typename?: 'Docker', id: string, organizer: { __typename?: 'ResolvedOrganizerV1', version: number, views: Array<{ __typename?: 'ResolvedOrganizerView', id: string, name: string, root:
          | { __typename: 'OrganizerContainerResource', id: string, name: string, type: string, meta?: { __typename?: 'DockerContainer', id: string, names: Array<string>, state: ContainerState, status: string, image: string, autoStart: boolean, created: number, isUpdateAvailable?: boolean | null, isRebuildReady?: boolean | null, ports: Array<{ __typename?: 'ContainerPort', privatePort?: number | null, publicPort?: number | null, type: ContainerPortType }>, hostConfig?: { __typename?: 'ContainerHostConfig', networkMode: string } | null } | null }
          | { __typename: 'OrganizerResource' }
          | { __typename: 'ResolvedOrganizerFolder', id: string, name: string, type: string, children: Array<
              | { __typename: 'OrganizerContainerResource', id: string, name: string, type: string, meta?: { __typename?: 'DockerContainer', id: string, names: Array<string>, state: ContainerState, status: string, image: string, autoStart: boolean, created: number, isUpdateAvailable?: boolean | null, isRebuildReady?: boolean | null, ports: Array<{ __typename?: 'ContainerPort', privatePort?: number | null, publicPort?: number | null, type: ContainerPortType }>, hostConfig?: { __typename?: 'ContainerHostConfig', networkMode: string } | null } | null }
              | { __typename: 'OrganizerResource' }
              | { __typename: 'ResolvedOrganizerFolder', id: string, name: string, type: string, children: Array<
                  | { __typename: 'OrganizerContainerResource', id: string, name: string, type: string, meta?: { __typename?: 'DockerContainer', id: string, names: Array<string>, state: ContainerState, status: string, image: string, autoStart: boolean, created: number, isUpdateAvailable?: boolean | null, isRebuildReady?: boolean | null, ports: Array<{ __typename?: 'ContainerPort', privatePort?: number | null, publicPort?: number | null, type: ContainerPortType }>, hostConfig?: { __typename?: 'ContainerHostConfig', networkMode: string } | null } | null }
                  ...
                  | { __typename: 'ResolvedOrganizerFolder', id: string, name: string, type: string, children: Array<
                      | { __typename: 'OrganizerContainerResource', id: string, name: string, type: string, meta?: { __typename?: 'DockerContainer', id: string, names: Array<string>, state: ContainerState, status: string, image: string, autoStart: boolean, created: number, isUpdateAvailable?: boolean | null, isRebuildReady?: boolean | null, ports: Array<{ __typename?: 'ContainerPort', privatePort?: number | null, publicPort?: number | null, type: ContainerPortType }>, hostConfig?: { __typename?: 'ContainerHostConfig', networkMode: string } | null } | null }
                      | { __typename: 'OrganizerResource' }
                      | { __typename: 'ResolvedOrganizerFolder', id: string, name: string, type: string }
                    > }
                > }
            > }
         }> } } };
...
export type CreateDockerFolderMutation = { __typename?: 'Mutation', createDockerFolder: { __typename?: 'ResolvedOrganizerV1', version: number, views: Array<{ __typename?: 'ResolvedOrganizerView', id: string, name: string, root:
        | { __typename: 'OrganizerContainerResource' }
        | { __typename: 'OrganizerResource' }
        | { __typename: 'ResolvedOrganizerFolder', id: string, name: string, type: string, children: Array<
            | { __typename: 'OrganizerContainerResource', id: string, name: string, type: string }
            | { __typename: 'OrganizerResource' }
            | { __typename: 'ResolvedOrganizerFolder', id: string, name: string, type: string }
          > }
       }> } };
...
export type DeleteDockerEntriesMutation = { __typename?: 'Mutation', deleteDockerEntries: { __typename?: 'ResolvedOrganizerV1', version: number, views: Array<{ __typename?: 'ResolvedOrganizerView', id: string, name: string, root:
        | { __typename: 'OrganizerContainerResource' }
        | { __typename: 'OrganizerResource' }
        | { __typename: 'ResolvedOrganizerFolder', id: string, name: string, type: string, children: Array<
            | { __typename: 'OrganizerContainerResource', id: string, name: string, type: string }
...
export type MoveDockerEntriesToFolderMutation = { __typename?: 'Mutation', moveDockerEntriesToFolder: { __typename?: 'ResolvedOrganizerV1', version: number, views: Array<{ __typename?: 'ResolvedOrganizerView', id: string, name: string, root:
        | { __typename: 'OrganizerContainerResource' }
        | { __typename: 'OrganizerResource' }
        | { __typename: 'ResolvedOrganizerFolder', id: string, name: string, type: string, children: Array<
            | { __typename: 'OrganizerContainerResource', id: string, name: string, type: string }
...
export type GetDockerContainerOverviewFormQueryVariables = Exact<{
  skipCache?: InputMaybe<Scalars['Boolean']['input']>;
}>;


export type GetDockerContainerOverviewFormQuery = { __typename?: 'Query', dockerContainerOverviewForm: { __typename?: 'DockerContainerOverviewForm', id: string, dataSchema: any, uiSchema: any, data: any } };
...
export type SetDockerFolderChildrenMutation = { __typename?: 'Mutation', setDockerFolderChildren: { __typename?: 'ResolvedOrganizerV1', version: number, views: Array<{ __typename?: 'ResolvedOrganizerView', id: string, name: string, root:
        | { __typename: 'OrganizerContainerResource' }
        | { __typename: 'OrganizerResource' }
        | { __typename: 'ResolvedOrganizerFolder', id: string, name: string, type: string, children: Array<
            | { __typename: 'OrganizerContainerResource', id: string, name: string, type: string }
